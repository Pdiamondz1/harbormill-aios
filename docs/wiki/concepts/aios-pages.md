...
created: 2026-06-17
updated: 2026-06-19
sources: [src/pages/Overview.tsx, src/pages/Briefings.tsx, src/pages/Findings.tsx, src/pages/Audits.tsx, src/pages/AuditDetail.tsx, src/pages/Strategy.tsx, src/pages/Assistant.tsx, src/pages/Workspace.tsx, src/pages/WorkspaceCallback.tsx, src/pages/Login.tsx]
...
| **Audits** | `Audits.tsx` | `useAudits` (prospect list/create) | **admin only** (`tier="admin"` + `audits` flag) |
| **AuditDetail** | `AuditDetail.tsx` | `useAudit` + `useSaveOpportunity`; export report → Doc | **admin only** (`tier="admin"` + `audits` flag) |
